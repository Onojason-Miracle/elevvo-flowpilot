      ...
      <div className="rounded-3xl border border-zinc-200 bg-gradient-to-tr from-indigo-600 via-violet-600 to-fuchsia-600 p-1 shadow-xl dark:border-zinc-800">
        <div className="rounded-[22px] bg-white p-8 text-center dark:bg-zinc-950">
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <Link to="/register"   className="inline-flex items-center justify-center rounded-xl bg-indigo-600 px-6 py-3 text-sm font-semibold text-white shadow transition hover:bg-indigo-500">Create Account</Link>

            <a
              href="#pricing"
              className="inline-flex items-center justify-center rounded-xl border border-zinc-300 px-6 py-3 text-sm font-semibold shadow-sm hover:shadow hover:bg-gray-100 hover:text-zinc-700 dark:border-zinc-700"
            >
              See pricing
            </a>
          </div>
